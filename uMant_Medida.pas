  ...
  begin
    ...
    TRY
      ...
      TRY
        ...
        MsgAviso('MEDIDA REGISTRADA CON ID : '+IntToStr(nId));
        IniPant;
...
procedure TfrMant_Medida.edDireccionKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TfrMant_Medida.edDocumentoKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
